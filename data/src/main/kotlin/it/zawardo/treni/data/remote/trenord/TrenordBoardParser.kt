 ...
 *
 * Quello che ne esce e' orario di tabella e nient'altro: nessun ritardo, nessun
 * binario, nessuna soppressione. Serve a sapere **quali corse dovrebbero
 * esserci**; se una di queste manca dal tabellone di ViaggiaTreno, il perche' lo
 * chiede il repository alla corsa stessa.
 */
internal object TrenordBoardParser {
    ...
    private fun parseBlock(block: String, departureDateMillis: Long): BoardEntry? {
        ...
        return BoardEntry(
            trainRef = TrainRef(
                number = number,
                // Trenord non espone il codice origine: la corsa si risolve
            ...
            direction = direction,
            scheduledTime = time,
            // Orario di tabella: ritardi, binari e soppressioni qui non ci sono.
            // Dichiararli a zero sarebbe una bugia, restano assenti.
            delayMinutes = 0,
